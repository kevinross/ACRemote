...
Public Class JsonRpcClient
    ...
    Public Function InvokeMethod(method As String, ParamArray p As Object()) As Object
        Dim r As JObject = Me.InvokeMethod_(method, p)
        Dim t As JToken = r.GetValue("result")
        If t Is Nothing Then
            Return Nothing
        End If
        Return r.SelectToken("result").ToObject(Of Object)()
    End Function
    ' Invoke a method and return a cast to T
    Public Function InvokeMethod(Of T)(method As String, ParamArray p As Object()) As T
        Dim r As JObject = Me.InvokeMethod_(method, p)
        Dim q As JToken = r.GetValue("result")
        If q Is Nothing Then
            Return Nothing
        End If
        Return DirectCast(r.SelectToken("result").ToObject(Of T)(), T)
    End Function
    ...
    Public Function InvokeMethod_(a_sMethod As String, ParamArray a_params As Object()) As JObject
        ...
        If a_params IsNot Nothing Then
