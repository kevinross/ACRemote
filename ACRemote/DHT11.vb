...
Public MustInherit Class DHT11
    ...
    ' update the cached value of the temperature
    Public Property temperature As Double Implements IDHT11.temperature
        ...
        End Set
    End Property
    ' update the cached value of the humidity
    ...
    ' the sensor can only update once every 2 seconds or so; force a wait if the most recent request is more than 100ms from the last request
