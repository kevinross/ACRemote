...
Namespace ACRemote
    Public Class Remote
        ...
        Public Property power As Boolean Implements IRemote.power
            ...
            End Set
        End Property
        ' target temperature in C (A/C unit tracks F, we convert)
        Private Property temp As Integer Implements IRemote.temp
            Get
                Return CInt((Me.temp_ - 32) * 5 / 9)
            End Get
            Set
                Me.power = True
                Dim t As Integer = CInt((Value / 9 / 5) + 32)
                Me.go_to_temp(If(t > 60, t, 61))
                Me.temp_ = Value
